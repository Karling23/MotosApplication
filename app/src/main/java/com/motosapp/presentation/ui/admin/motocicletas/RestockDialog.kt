// presentation/ui/admin/motocicletas/RestockDialog.kt
...
fun RestockDialog(
    ...
    AlertDialog(
        ...
        title = {
            Column {
                Text(
                    "Restock: ${motocicleta.displayName}",
                ...
                Text(
                    "Stock actual: ${motocicleta.stock} unidades",
                    style = MaterialTheme.typography.bodySmall,
                    color = if (motocicleta.stock == 0) Error else TextSecondary,
                )
            }
        },
        text = {
            Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                ...
                if (qtyVal != null && qtyVal > 0) {
                    Text(
                        "Nuevo stock: ${motocicleta.stock + qtyVal} unidades",
                        style = MaterialTheme.typography.bodySmall,
                        color = TextSecondary,
                    )
                }
